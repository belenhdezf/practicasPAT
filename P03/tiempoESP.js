...
fetch(`https://api.weatherbit.io/v2.0/current?city=${document.getElementById("search-input").value},&key=aeaaccd55af141f9bf1473ea2cd6c474&include=hourly&lang=es`, {
  headers: {
              ...
              +'<div class = "col">' 
                +'<div class ="row">'
                  +'<div class= "col-3">'
                    ...
                    +`<h2 class="card-text">${r.data[0].temp} ºC</h2>`
                    +`<h6 class="card-text">${r.data[0].weather.description}</h6>`
                    +`<p class="card-text"><small class="text-muted"><b>Sensación térmica ${r.data[0].app_temp}ºC</b></small></p>`
                  +'</div>'
                  +'<div class="col-1">'
            ...
            +'<div class="row">'
              +'<div class= "col">'
                ...
                +'<div class="alert alert-danger alert-dismissible fade show" role="alert">'
                  +`<h4 class="alert-heading">Alertas de viento</h4>`            
                  +'<hr>'
                  +`<h5><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-speedometer" viewBox="0 0 16 16"><path d="M8 2a.5.5 0 0 1 .5.5V4a.5.5 0 0 1-1 0V2.5A.5.5 0 0 1 8 2zM3.732 3.732a.5.5 0 0 1 .707 0l.915.914a.5.5 0 1 1-.708.708l-.914-.915a.5.5 0 0 1 0-.707zM2 8a.5.5 0 0 1 .5-.5h1.586a.5.5 0 0 1 0 1H2.5A.5.5 0 0 1 2 8zm9.5 0a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1H12a.5.5 0 0 1-.5-.5zm.754-4.246a.389.389 0 0 0-.527-.02L7.547 7.31A.91.91 0 1 0 8.85 8.569l3.434-4.297a.389.389 0 0 0-.029-.518z"/><path fill-rule="evenodd" d="M6.664 15.889A8 8 0 1 1 9.336.11a8 8 0 0 1-2.672 15.78zm-4.665-4.283A11.945 11.945 0 0 1 8 10c2.186 0 4.236.585 6.001 1.606a7 7 0 1 0-12.002 0z"/></svg>   Velocidad del viento: ${r.data[0].wind_spd} m/s</h5>`
                  +`<h5><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-signpost-split" viewBox="0 0 16 16"><path d="M7 7V1.414a1 1 0 0 1 2 0V2h5a1 1 0 0 1 .8.4l.975 1.3a.5.5 0 0 1 0 .6L14.8 5.6a1 1 0 0 1-.8.4H9v10H7v-5H2a1 1 0 0 1-.8-.4L.225 9.3a.5.5 0 0 1 0-.6L1.2 7.4A1 1 0 0 1 2 7h5zm1 3V8H2l-.75 1L2 10h6zm0-5h6l.75-1L14 3H8v2z"/></svg>   Dirección del viento: ${r.data[0].wind_cdir_full}</h5>`
                  +'<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>'

                +'</div>'

                +'<div class="alert alert-success alert-dismissible fade show" role="alert">'
                  +`<h4 class="alert-heading">Sensación térmica</h4>`
                  +'<hr>'
                  +`<h5><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-thermometer" viewBox="0 0 16 16"><path d="M6 2a2 2 0 1 1 4 0v7.627a3.5 3.5 0 1 1-4 0V2zm2-1a1 1 0 0 0-1 1v7.901a.5.5 0 0 1-.25.433A2.499 2.499 0 0 0 8 15a2.5 2.5 0 0 0 1.25-4.666.5.5 0 0 1-.25-.433V2a1 1 0 0 0-1-1z"/><path d="M9.5 12.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/></svg>   Sensación térmica en el exterior de ${r.data[0].app_temp}ºC</h5>`
                ...
                +'<div class="alert alert-primary alert-dismissible fade show" role="alert">'
                  +`<h4 class="alert-heading">Hora y fecha últ. update | Zona horaria</h4>`            
                  +'<hr>'
                  +'<div class="row">'
                    +'<div class="col">'
